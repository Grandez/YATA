modSellInput <- function(id) {
  ...
  tableOper = {tags$table(class = "box-table",
                      ...
                      ,tags$tr( tags$td("Saldo", class="tblLabel")
                                ,tags$td(class="tblRow",colspan="6",verbatimTextOutput(ns("lblSaldo")))
                      )
                      
                      ,tags$tr( tags$td("Amount", class="tblLabel")
                                ,tags$td(class="tblRow",colspan="6",numericInput(ns("txtAmount"), label = NULL, value = 0))
                      )
                      ,tags$tr( tags$td("Camera Fee", class="tblLabel")
                                ,tags$td(class="tblRow",colspan="6",numericInput(ns("txtFeeCam"), label = NULL, value = 0))
                      )
                      ,tags$tr( tags$td("Blockchain Fee", class="tblLabel")
                                ,tags$td(class="tblRow",colspan="6",numericInput(ns("txtFeeCTC"), label = NULL, value = 0))
                      )
                      ,tags$tr( tags$td("Other Fee", class="tblLabel")
                                ,tags$td(class="tblRow",colspan="6",numericInput(ns("txtFeeOTH"), label = NULL, value = 0))
                      )
                      ,tags$tr( tags$td("Max Limiit", class="tblLabel")
                                ,tags$td(class="tblRow",colspan="6",numericInput(ns("txtLimit"), label = NULL, value = 0))
                      )
                      ,tags$tr( tags$td("Stop", class="tblLabel")
                                ,tags$td(class="tblRow",colspan="6",numericInput(ns("txtStop"), label = NULL, value = 0))
                      )
